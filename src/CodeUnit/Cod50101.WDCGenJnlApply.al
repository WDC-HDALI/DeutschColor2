codeunit 50101 "WDC Gen. Jnl.-Apply"
{
    ...
    var
        ...
        ApplyCustEntries: Page "wdc Apply Customer Entries";
        IsHandled: Boolean;
        lChequelines: Record "Cheque Line";
    //Textfilter: Text[1000];
    begin
        IsHandled := false;
        ...
        with GenJnlLine do begin
            ...
            // CustLedgEntry.SetRange("Cheque No. Of Invoivce", GenJnlLine."Cheque No.");
            // CustLedgEntry.SetRange("Document Type", "Document Type"::Invoice);
            // CustLedgEntry.SetRange(Open, true);
            CustLedgEntry.SetCurrentKey("Customer No.", Open, Positive);
            CustLedgEntry.CalcFields("Cheque No. Of Invoivce");
            CustLedgEntry.SetRange("Cheque No. Of Invoivce", GenJnlLine."Cheque No.");
            CustLedgEntry.SetRange("Document Type", "Document Type"::Invoice);
            CustLedgEntry.SetRange(Open, true);
            ...
            ApplyCustEntries.SetAppliesToIdByPaymentJournal("Document No.");
