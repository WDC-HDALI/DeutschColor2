page 50101 "WDC Apply Customer Entries"
{
    ...
    begin
        StyleTxt := SetStyle;
        CalcFields("Cheque No. Of Invoivce");
        Rec.Validate("Applies-to ID", AppllyToIdGlobal);//Hdali
        Validate("Amount to Apply", GetAmoutToApplyFromChequeList("Cheque No. Of Invoivce", "Document No."));
    end;
                    ...
                    case ApplnType of
                            ...
                            begin
                                ...
                                with AppliedCustLedgEntry do begin
                                    ...
                                    if "Currency Code" <> ApplnCurrencyCode then begin
                                        ...
                                        "Amount to Apply" :=
                                          CurrExchRate.ExchangeAmtFCYToFCY(
                                            ApplnDate, "Currency Code", ApplnCurrencyCode, GetAmoutToApplyFromChequeList(Rec."Cheque No. Of Invoivce", Rec."Document No.")); //"Amount to Apply");//Hdali 
                                    end;
                        ...
                        ApplnType::"Applies-to ID":
                            begin
                                ...
                                AppliedCustLedgEntry.SetRange("Cheque No. Of Invoivce", GenJnlLine."Cheque No.");
                                AppliedCustLedgEntry.SetRange("Document Type", Rec."Document Type"::Invoice);
    ...
    begin
        if ApplnType <> ApplnType::"Applies-to Doc. No." then begin
            CalcApplnAmount;
            CurrPage.Update(false);
            GetAmoutToApplyFromChequeList(Rec."Cheque No. Of Invoivce", Rec."Document No.") //Hdali
        end;
    end;
    ...
    procedure SetAppliesToIdByPaymentJournal(var AppL_Id: Code[20])
    begin
        AppllyToIdGlobal := AppL_Id;
    end;

    procedure GetAmoutToApplyFromChequeList(pChequeNo: Code[20]; pInvoiceNo: Code[20]): Decimal
    var
